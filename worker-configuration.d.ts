/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 72c88458c1f5175deb1ae40fe123a9e1)
// Runtime types generated with workerd@1.20260820.1 2026-08-17 
interface __BaseEnv_Env {
	GRAFANA_LTX_BUCKET: R2Bucket;
	HOME_PROMETHEUS: Fetcher;
	BROWSER: BrowserRun;
	AI: Ai;
	...
	JWT_SIGN_KEY: string;
	__DO_NOT_DEPLOY?: string;
	GRAFANA: DurableObjectNamespace<import("./src/index").Grafana>;
	GRPC: Fetcher /* grpc-gateway */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Grafana";
	}
	interface DevEnv {
		GRAFANA_LTX_BUCKET: R2Bucket;
		HOME_PROMETHEUS: Fetcher;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENV" | "MACKEREL_APIKEY" | "JWT_SIGN_KEY" | "__DO_NOT_DEPLOY">> {}
}
